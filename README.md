...
| [variant-clone-factory](docs/skills/variant-clone-factory.md) | 把 Variant 共享模板链接复刻为 React 工程，导出 ZIP，并可进行像素级视觉验收 | Variant 共享链接、Docker 或 Node.js、可访问 variant.com 的网络 | 网页复刻、Variant、React | [![GitHub](https://img.shields.io/badge/GitHub-variant--clone--factory-24292f?logo=github)](https://github.com/lulistart/variant-clone-factory) | [![Stars](https://img.shields.io/github/stars/lulistart/variant-clone-factory?style=social)](https://github.com/lulistart/variant-clone-factory/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2642041) |
| [gc-minimal-zine-poster-v0-3](docs/skills/gc-minimal-zine-poster.md) | 把主题、文章、照片或参考图转成留白充足的纸刊风极简海报，并输出可复用的生图 Prompt | 图片生成能力、参考图分析需可读取图片 | 生图、纸刊海报、极简设计 | [![GitHub](https://img.shields.io/badge/GitHub-gc--minimal--zine--poster-24292f?logo=github)](https://github.com/LiamGvchi/gc-minimal-zine-poster) | [![Stars](https://img.shields.io/github/stars/LiamGvchi/gc-minimal-zine-poster?style=social)](https://github.com/LiamGvchi/gc-minimal-zine-poster/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2735151) |
| [photo-abstract-editorial](docs/skills/photo-abstract-editorial.md) | 保留原照片不改动，在下方用照片关系生成极简抽象记忆面板，组成竖版编辑作品 | 照片、图片生成能力、仅限非商业使用 | 生图、照片编辑、抽象艺术 | [![GitHub](https://img.shields.io/badge/GitHub-photo--abstract--editorial-24292f?logo=github)](https://github.com/ZzzLc0405/photo-abstract-editorial) | [![Stars](https://img.shields.io/github/stars/ZzzLc0405/photo-abstract-editorial?style=social)](https://github.com/ZzzLc0405/photo-abstract-editorial/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2735151) |
| [gathered-scenes-zine-skill](docs/skills/gathered-scenes-zine-skill.md) | 一组照片纸刊技能：可保留真实照片做撕纸拼贴，也可只提炼照片语义重新创作编辑插画 | 照片、图片生成能力、仅限个人非商业使用 | 生图、纸刊拼贴、影像蒸馏 | [![GitHub](https://img.shields.io/badge/GitHub-gathered--scenes--zine--skill-24292f?logo=github)](https://github.com/Zeejay0/gathered-scenes-zine-skill) | [![Stars](https://img.shields.io/github/stars/Zeejay0/gathered-scenes-zine-skill?style=social)](https://github.com/Zeejay0/gathered-scenes-zine-skill/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2735151) |
...
| [deep-research](docs/skills/deep-research.md) | 通过 `/research` 自动生成多语言深度调研报告，支持在线搜索、本地资料、多 Agent 并行撰写和质量检查 | LLM 运行时、Scrapling/网络（在线）、本地资料可选 | 深度调研、研究报告、多 Agent | [![GitHub](https://img.shields.io/badge/GitHub-deep--research-24292f?logo=github)](https://github.com/hoolulu/deep-research) | [![Stars](https://img.shields.io/github/stars/hoolulu/deep-research?style=social)](https://github.com/hoolulu/deep-research/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2312664) |
...
| [agents-progressive-disclosure](docs/skills/agents-progressive-disclosure.md) | 把臃肿的 AGENTS.md、CLAUDE.md 等指令文件重构成精简入口和按需读取文档，降低常驻上下文负担 | 现有 Agent 指令文件、可编辑 docs/rules、Git/备份 | Agent 指令、渐进式披露、上下文治理 | [![GitHub](https://img.shields.io/badge/GitHub-agents--progressive--disclosure-24292f?logo=github)](https://github.com/Caph-dev/agents-progressive-disclosure) | [![Stars](https://img.shields.io/github/stars/Caph-dev/agents-progressive-disclosure?style=social)](https://github.com/Caph-dev/agents-progressive-disclosure/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2263095) |
| [agent-cli-creator](docs/skills/agent-cli-creator.md) | 为特定网站生成可复用 CLI，让 Agent 通过真实 Chrome 登录态执行网页读写操作 | 目标网站 URL、kimi-webbridge、已登录 Chrome、CLI 语言环境 | 网页 CLI、浏览器自动化、CLI 生成 | [![GitHub](https://img.shields.io/badge/GitHub-agent--cli--creator-24292f?logo=github)](https://github.com/better-world-ai/agent-cli-creator) | [![Stars](https://img.shields.io/github/stars/better-world-ai/agent-cli-creator?style=social)](https://github.com/better-world-ai/agent-cli-creator/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2269051) |
| [OpenCLI](docs/skills/opencli.md) | 把网站、真实浏览器会话、Electron 应用和本地工具统一封装成 Agent 可调用的 CLI | Node.js 20+、OpenCLI、Browser Bridge、真实浏览器登录态 | 网页 CLI、CLI 枢纽、站点适配器 | [![GitHub](https://img.shields.io/badge/GitHub-OpenCLI-24292f?logo=github)](https://github.com/jackwener/OpenCLI) | [![Stars](https://img.shields.io/github/stars/jackwener/OpenCLI?style=social)](https://github.com/jackwener/OpenCLI/stargazers) | [![Linux.do](https://cdn3.ldstatic.com/optimized/4X/c/c/d/ccd8c210609d498cbeb3d5201d4c259348447562_2_32x32.png)](https://linux.do/t/topic/2269051) |
...
- [variant-clone-factory](docs/skills/variant-clone-factory.md)：Variant 共享模板复刻工具，从可访问页面生成 React 工程 ZIP，并以视觉差异检查结果；与图片输入的 `image-to-code-skill` 不同，它直接处理 Variant 页面。
  > description：通用 Variant 模板复刻工厂：粘贴共享链接 → 1:1 还原 React 工程 → 导出 ZIP。

- [gc-minimal-zine-poster-v0-3](docs/skills/gc-minimal-zine-poster.md)：留白充足的极简 ZINE 海报工作流，支持主题、文章、照片和参考图分析；与照片专用的两项纸刊技能相比，它还可沉淀可复用的视觉系统和 Prompt。
  > description：生成或分析带纸张质感、大片留白、小型编辑拼贴或视觉焦点、实验排版和单一明确色彩强调的诗意极简 ZINE 海报。适用于用户提供主题、句子、文章、情绪、物件、照片、内容简报、参考图或图片文件夹，并希望获得最终海报、生图 Prompt、可复用风格规则或同一视觉家族内的多种版式时。

- [photo-abstract-editorial](docs/skills/photo-abstract-editorial.md)：把真实照片与由其空间、构图和色彩关系提炼出的抽象面板组合成竖版编辑作品；原照片不重画、不套滤镜。
  > description：创建一张干净的竖版编辑作品：保留上传照片原貌，搭配克制的、从照片中提取的抽象记忆面板和诗意英文标题。适用于希望把照片转化为抽象编辑双联画、照片加抽象构图、视觉记忆面板或极简档案海报，且不重画或风格化原图的需求。

- [gathered-scenes-zine-skill](docs/skills/gathered-scenes-zine-skill.md)：照片纸刊技能套件，可选保留真实摄影的撕纸拼贴，或舍弃照片、只保留场景语义的影像蒸馏插画。
  > description：包含两条照片创作路径：实景拼贴将真实摄影置于源图导出的宽阔抽象插画场中，保留可见的手撕纤维边界和一处高纯度色彩；影像蒸馏则只把照片当作语义与情绪来源，重新创作一张独立的纸上编辑插画，不在成品中保留原照片。
...
- [deep-research](docs/skills/deep-research.md)：深度调研报告生成工作流，围绕一个主题自动规划大纲、采集资料、并行撰写章节、转换引用并完成质量检查。
  > description：专业深度调研报告生成：通过多 Agent 协作、并行章节撰写、自动锁定最新数据、多语言输出和内置质量检查生成报告。
...
- [agents-progressive-disclosure](docs/skills/agents-progressive-disclosure.md)：Agent 指令文件治理技能，把过长的 `AGENTS.md`、`CLAUDE.md` 等重构为精简入口和按需文档路由。
  > description：将臃肿的 AGENTS.md/CLAUDE.md 风格指令文件重构为紧凑路由入口和聚焦的按需文档。当用户要求应用渐进式披露、把 agent 规则拆分到 docs、减少指令膨胀，或把一个大型规则文件变成入口文件时使用。

- [agent-cli-creator](docs/skills/agent-cli-creator.md)：Agent 工具链生成技能，把某个具体网站的重复网页操作沉淀为 CLI；区别于 `agents-progressive-disclosure` 的指令治理，也区别于 `wechat-article-reader` 这类固定站点读取器。
  > description：当用户想要构建一个 CLI 工具，通过 kimi-webbridge 自动化特定网站上的浏览器交互时使用。用户说“为某个网站创建 CLI”、“构建自动化某网站的工具”，或希望通过 AI agent 以编程方式控制网站时触发。

- [OpenCLI](docs/skills/opencli.md)：网站、真实浏览器会话、站点 adapter、外部 CLI 和 Electron 应用的统一 CLI 枢纽；相比 `agent-cli-creator`，它已经提供运行时和多套官方 skills。
  > description：当 Agent 需要通过 opencli 驱动真实 Chrome 窗口时使用：检查页面、填写表单、点击登录后流程，或临时提取数据。覆盖 selector-first 目标契约、复合表单字段、过期引用处理、网络捕获，以及 CLI 返回的 Agent 原生结构化 envelope。它不用于编写 adapter；编写 adapter 请使用 opencli-adapter-author。

- [CLI-Anything](docs/skills/cli-anything.md)：专业软件 CLI 市场和工作流矩阵，通过 CLI-Hub 帮 Agent 发现、安装和组合图像、视频、3D、办公、AI 等工具。
  > description：发现面向专业软件的 Agent 原生 CLI。访问实时目录，为创意工作流、生产力、AI 等场景查找工具。

- [bb-browser](docs/skills/bb-browser.md)：真实浏览器登录态的 CLI/MCP 执行层，适合网页读取、表单操作、带 Cookie fetch、网络调试和站点 adapter 调用。
